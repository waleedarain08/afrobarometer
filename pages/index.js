              ...
              <div className="col-md-7 col-12">
                <div className="home--content">
                  ...
                  <div className="home--author">
                    ...
                    Africa. The company enables the collection and the delivery
                    of on-demand, real-time, cost-effective, and reliable Africa
              ...
              <div className="row mx-0">
                ...
                <div className="col-md-7 col-12 second-div-home-right">
                  ...
                  <div className="home-second-author">
                    ...
                    availability of first-party data to businesses and
                    researchers interested in gaining insights about the Africa
                    consumers and business landscape. Today, AfriSight is the
                    leading, Africa-focused sample panel providers with a
                    growing panelist community across the African continent.
                    <br />
                    <br />
                    ...
                    parastatals, educational institutions and even other sample
                    panel providers with little or no footprint in Africa.
                    <br />
                    <br />
                  ...
                  <div className="col-md-6 col-12">
                    <div className="home-third-content">
                      ...
                      <div className="home-third-author">
                        We are employing technology and a unique market
                        experience to provide solutions that aptly meet the
                        needs of clients including research agencies,
                        advertising agencies, corporates and SMEs, NGOs,
                        government agencies and parastatals, educational
                        institutions and even other sample panel providers with
                        little or no footprint in Africa.
                        <br />
                        <br />
                        AfriSight changing the game in Africa!
                      </div>
